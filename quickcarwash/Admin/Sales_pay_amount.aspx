<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sales_pay_amount.aspx.cs" Inherits="Admin_Sales_pay_amount" %>
...
<div class="container">
 ...
 <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="3" 
      ...
      <Columns>
       ...
       <asp:BoundField HeaderText="Customer" DataField="Buyer"  >
          <HeaderStyle CssClass="Grd1" />
          <ItemStyle CssClass="Grd1" />
          </asp:BoundField>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ExpenseName_Entry.aspx.cs" Inherits="Admin_ExpenseName_Entry" %>
   ...
   <div class="col-md-6">
                 <div class="panel-body">
                           <div class="form-horizontal">
                               <br />
                               <div class="form-group"><label class="col-lg-3 control-label">Expense Id</label>
...
<div class="col-md-12">
   ...
   <asp:GridView ID="GridView1" runat="server" class="Grd1" Width="100%" CellPadding="3" 
       ...
       <asp:TemplateField>
           ...
           <asp:BoundField HeaderText="Expense Id" DataField="ExpName_Code"  >

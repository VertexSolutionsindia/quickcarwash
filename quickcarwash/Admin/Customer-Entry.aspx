...
<html lang="en">
    ...
    .addEventListener("keyup", function (event) {
        ...
        <link href="css/style.css" type="text/css" rel="stylesheet"> 
         <link href="css1/Customer-Entrycss.css" type="text/css" rel="stylesheet"> 
...
<asp:Button ID="Button4" runat="server"  Text="ADD" class="btn btn-primary"></asp:Button> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> </a>
  ...
  <div class="panel-body">
   <div class="col-md-6">
                 <div class="panel-body">
                           <div class="form-horizontal">
                               <br />
                               <div class="form-group"><label class="col-lg-3 control-label">Customer ID : </label>
   ...
   <ContentTemplate>
               ...
               <div class="form-group"><label class="col-lg-3 control-label">E-Mail ID : </label>
                              
                                    <div class="col-lg-9">
                                     <asp:UpdatePanel ID="UpdatePanel6" runat="server">
   <ContentTemplate>
                                    <asp:TextBox ID="TextBox4" runat="server" class="form-control input-x2 dropbox" ontextchanged="TextBox9_TextChanged" 
                                        ></asp:TextBox>
                                    </ContentTemplate>
                                     <Triggers>
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
  ...
  <br /> 
                           <div class="form-horizontal">
                               <br />
                         <div class="form-group"><label class="col-lg-3 control-label">Customer Vehicle No : </label>
   ...
   <ContentTemplate>
                                    <asp:TextBox ID="TextBox15" runat="server" class="form-control input-x2 dropbox" ontextchanged="TextBox9_TextChanged" 
                                        ></asp:TextBox>
                                    </ContentTemplate>
                                     <Triggers>
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
   ...
   <ContentTemplate>
                                    <asp:TextBox ID="TextBox17" runat="server" class="form-control input-x2 dropbox" ontextchanged="TextBox9_TextChanged" 
                                        ></asp:TextBox>
                                    </ContentTemplate>
                                     <Triggers>
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
   ...
   <asp:GridView ID="GridView1" runat="server" class="Grd1" Width="100%" CellPadding="3" 
       ...
       <Columns>
        <asp:TemplateField>
           ...
           <asp:BoundField HeaderText="Customer ID" DataField="Custom_Code"  >
    ...
    <asp:Panel ID="Panel2" runat="server" class="panel1" BorderColor="Black" BorderStyle="Solid" BackColor="White" Direction="LeftToRight" style="display:none;" 
      ...
      <tr>
        ...
        <td>
         ...
         <tr>
        <td>
            <asp:Label ID="Label3" runat="server" Text="E-Mail ID" class="col-lg-3 control-label" Width="200px"></asp:Label></td>
        <td>
            <asp:TextBox ID="TextBox7" runat="server"  class="form-control input-x2 dropbox"></asp:TextBox></td>
        </tr>
         <tr>
        <td>
            <asp:Label ID="Label4" runat="server" Text="Customer Vehicle No" class="col-lg-3 control-label" Width="200px"></asp:Label></td>
        <td>
            <asp:TextBox ID="TextBox8" runat="server"  class="form-control input-x2 dropbox"></asp:TextBox></td>
        </tr>
             <tr>
        <td>
            <asp:Label ID="Label6" runat="server" Text="Vehicle Brand" class="col-lg-3 control-label" Width="200px"></asp:Label></td>
        <td>
            <asp:TextBox ID="TextBox12" runat="server" class="form-control input-x2 dropbox"></asp:TextBox></td>
        </tr>    
               <tr>
        <td>
            <asp:Label ID="Label7" runat="server" Text="Vehicle Make" class="col-lg-3 control-label" Width="200px"></asp:Label></td>
        <td>

<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="WorkshopBilling_entry.aspx.cs" Inherits="Admin_WorkshopBilling_entry" %>
...
<asp:Button ID="Button4" runat="server"  Text="ADD" class="btn btn-primary"></asp:Button> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> </a>
  ...
  <asp:Button ID="Button10" runat="server" Text="New" Width="70px" Height="30px" onclick="Button10_Click"></asp:Button>
   <asp:Button ID="Button9" runat="server" Text="Save" Width="70px" Height="30px" onclick="Button9_Click" 
           ></asp:Button>
    <asp:Button ID="Button11" runat="server" Text="Clear" Width="70px" Height="30px" onclick="Button11_Click"></asp:Button>
...
<%--  <div class="panel panel-default">
  ...
  <div class="panel-body">
   ...
   <ContentTemplate>
                                    <asp:TextBox ID="TextBox3" runat="server" AutoPostBack="true" class="form-control input-x2 dropbox" 
                                        ontextchanged="TextBox3_TextChanged" onload="TextBox3_Load"></asp:TextBox>
                                                                  <asp:AutoCompleteExtender ID="AutoCompleteExtender3" runat="server" MinimumPrefixLength="1" ServiceMethod="SearchWorkshopName" FirstRowSelected = "false" CompletionInterval="0" EnableCaching="false" CompletionSetCount="10" TargetControlID="TextBox3"  CompletionListCssClass="completionList"
 ...
 <div class="col-sm-4">
 <div class="col-lg-12">
                              <div class="form-group"><label class="col-lg-4 control-label">WorkShop Name: </label>
...
<div class="col-md-12">
   ...
   <asp:GridView ID="GridView1" runat="server" class="Grd1" Width="100%" CellPadding="3" 
    ...
    <br /><asp:Button ID="Button14" runat="server" Text="Delete Seleted Rows" CssClass="buttonbox" OnClientClick="return confirm('Do you want to delete this entry')" onclick="Button14_Click"/>
